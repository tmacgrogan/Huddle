...
public class Huddle {
    ...
    public static Huddle[] sampleInput() {
        ...
        test[0] = new Huddle(R.drawable.animal39, "Tennis", "CRC", "Looking for someone to play tennis with me later today. We can hit balls and talk about the Williams sisters, or whatever people who play Tennis do.",
                "Today, 4:00pm", "VX");
        test[1] = new Huddle(R.drawable.cat19, "Pickup Soccer", "CRC", "blahblahblahblahblahblah", "Today, 5:00pm", "AS");
        test[2] = new Huddle(R.drawable.deer4, "Calc II HW5 Help", "CULC", "blahblahblahblahblahblah", "Tomorrow, 1:00pm", "MS");
